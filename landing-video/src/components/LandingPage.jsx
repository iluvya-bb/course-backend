        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          >
            ...
            <div className="mt-8 flex justify-center md:justify-start space-x-4">
              ...
              <Button variant="secondary">{t("hero.button_tutor")}</Button>
            </div>
          </motion.div>
          <motion.div
  ...
  const testimonials = [
    {
      ...
      quote: t("testimonials.student_quote"),
    ...
    },
    {
      ...
      quote: t("testimonials.parent_quote"),
    ...
    },
    {
      ...
      quote: t("testimonials.teacher_quote"),
